    ...
    <v-row class="pt-5">
      <v-col cols="12" class="table-second-cell-right-align">
        <v-expansion-panels>
              ...
              <table class="view-profile-table-lineheight">
                ...
                <tr>
                  ...
                  <td>
                    :
                    {{
                      employeeObject.relation ? employeeObject.relation : "---"
                    }}
                  </td>
                </tr>
                <tr>
          ...
          <v-expansion-panel>
            <v-expansion-panel-header>
              <h5><v-icon>mdi-home-account</v-icon> Home Country - Details</h5>
            </v-expansion-panel-header>
            <v-expansion-panel-content>
              <table class="view-profile-table-lineheight">
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    :
                    {{
                      employeeObject.home_tel ? employeeObject.home_tel : "---"
                    }}
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    :
                    {{
                      employeeObject.home_fax ? employeeObject.home_fax : "---"
                    }}
                  </td>
                </tr>
                <tr>
          ...
          <v-expansion-panel>
            <v-expansion-panel-header>
              <h5><v-icon>mdi-passport-biometric</v-icon> Emirates Details</h5>
            </v-expansion-panel-header>
            <v-expansion-panel-content>
              <table class="view-profile-table-lineheight">
                <tr>
              ...
              <table class="view-profile-table-lineheight">
                <tr>
                  ...
                  <td>
                    :
                    {{
                      employeeObject.visa ? employeeObject.visa.visa_no : "---"
                    }}
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    :
                    {{
                      employeeObject.visa ? employeeObject.visa.country : "---"
                    }}
                  </td>
                </tr>
                <tr>
              ...
              <table class="view-profile-table-lineheight">
                ...
                <tr>
                  ...
                  <td>
                    :
                    {{
                      employeeObject.bank ? employeeObject.bank.address : "---"
                    }}
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    :
                    {{ employeeObject.bank ? employeeObject.bank.iban : "---" }}
                  </td>
                </tr>
                <tr>
                  <td>
          ...
          <v-expansion-panel>
            ...
            <v-expansion-panel-content>
              <table
                style="width: 100%; border-collapse: collapse; margin: 5px"
              >
                <thead>
                  <tr>
                ...
                <tr>
                  ...
                  <td class="text-right" style="float: right">
                    <v-switch
                      ...
                      color="success"
                      class="mt-0 ml-2"
                      v-model="employeeObject.user.mobile_app_login_access"
                    ></v-switch>
                  </td>
                </tr>
